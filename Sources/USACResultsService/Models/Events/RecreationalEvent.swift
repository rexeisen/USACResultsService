...
public struct RecreationalEvent: Event {
    
    public typealias SeriesType = RecreationalSeries
    ...
    public let categories: [RecreationalSeries.Category]
    
    public let region: RecreationalSeries.Region
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.categories = try container.decode([RecreationalSeries.Category].self, forKey: .categories)
        self.region = try container.decode(RecreationalSeries.Region.self, forKey: .region)
